  ...
  return (
    <div className="bg-transparent w-24 h-24 relative flex items-center justify-center">
      <svg width="100%" height="100%" viewBox="0 0 100 100" className="absolute top-0 left-0 drop-shadow-md">
        <path d="M 15 20 Q 50 20 85 50 Q 50 80 15 80 Q 30 50 15 20 Z" fill="white" stroke="#1f2937" strokeWidth="4" strokeLinejoin="round" />
        <text x="35" y="54" fontSize="12" fill="#1f2937" fontWeight="bold">OR</text>
      </svg>
