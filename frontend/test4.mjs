...
S_SET 8 state 61 2 SMOD_SET
S_RST state 1 6 5 SMOD_RST
C_STATE state 1 10p

E_OUT 3 1 VOL={V(state)>2.5 ? V(8) : 0}
S_DIS 7 1 8 state SMOD_DIS

.MODEL SMOD_SET SW(VT=0.01 RON=10 ROFF=100MEG)
.MODEL SMOD_RST SW(VT=0.01 RON=10 ROFF=100MEG)
.MODEL SMOD_DIS SW(VT=2.5 RON=1 ROFF=1G)
.ENDS NE555
